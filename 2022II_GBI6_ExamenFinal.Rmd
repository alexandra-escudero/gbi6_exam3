...
p5 <- ggcorrplot(select(pinguinos, c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g")), 
                 type = "upper", 
                 method = "circle", 
                 colors = c("pink", "green", "orange"), 
...
**INTERPRETACIÓN:** Se muestran salidas del color,
